...
const GuessTheElo: React.FC = () => {
  ...
  const handleNextGameWithReset = useCallback(() => {
    setHasGuessed(false);
    setGuessedElo(1500);
    fetchNewGame();
  }, [fetchNewGame]);
  ...
  }, [guessedElo, actualElo]);

  const toggleMobileGuess = useCallback(() => {
    setShowMobileGuess(prev => !prev);
  }, []);
