      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-gray-300 hover:text-neon-green">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="#" className="text-gray-300 hover:text-neon-green">Home</a></li>
            <li><a href="#" className="text-gray-300 hover:text-neon-green">Community Stats</a></li>
          </ul>
        </div>
        <div>
          <h3 className="text-lg font-semibold text-white mb-4">Community</h3>
          <ul className="space-y-2">
            <li><a href="#" className="text-gray-300 hover:text-neon-green">Discord</a></li>
            <li><a href="#" className="text-gray-300 hover:text-neon-green">YouTube</a></li>
            <li><a href="#" className="text-gray-300 hover:text-neon-green">Chess.com</a></li>
            <li><a href="#" className="text-gray-300 hover:text-neon-green">Twitter</a></li>
          </ul>
        </div>
        <div>
          <h3 className="text-lg font-semibold text-white mb-4">Legal</h3>
          <ul className="space-y-2">
            <li><a href="#" className="text-gray-300 hover:text-neon-green">Terms of Service</a></li>
            <li><a href="#" className="text-gray-300 hover:text-neon-green">Privacy Policy</a></li>
          </ul>
        </div>
      </div>
    </div>
